...
public class FoodServiceImpl implements FoodService{
    ...
    public FoodResponse readFoodById(String id) {
        FoodEntity foodEntity = foodRepository.findById(id).orElseThrow(()->new RuntimeException("Food id not found for id : "+id));
    ...
    public void deleteFood(String id) {
        ...
        boolean isFileDelete = this.deleteFile(filename);
        if(isFileDelete){
